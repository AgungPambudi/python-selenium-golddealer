...
while True:
    ...
    link = "https://www.golddealer.com/product-category/products-2/bullion/silver-bullion-coins-bars/?orderby=price-desc"
...
df.to_csv('data/silver_price.csv', index=False)
